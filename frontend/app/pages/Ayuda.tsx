...
export default function Ayuda() {
  ...
  const handleImageClick = () => {
    router.push("/AyudaMobile"); // Redirige a la página AyudaMobile
  };
...
/* Función que maneja el click en una subopción */
/* Actualiza la subopción seleccionada */
      ...
      <div className="top-bar">
        <img
          ...
          style={{ width: "60px", height: "60px" }}
           onClick={handleImageClick} // Asigna la función al evento onClick
        />
        <h1>Ayuda GatitoPlis</h1>
